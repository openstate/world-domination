"""
Starter fabfile for deploying the worlddomination project.
...
# CHANGEME
env.hosts = ['user@worlddomination.example.com']
env.code_dir = '/srv/www/worlddomination'
env.project_dir = '/srv/www/worlddomination/worlddomination'
env.static_root = '/srv/www/worlddomination/static/'
env.virtualenv = '/srv/www/worlddomination/.virtualenv'
env.code_repo = 'git@github.com:user/worlddomination.git'
env.django_settings_module = 'worlddomination.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/worlddomination/wsgi.py" % env.code_dir)
