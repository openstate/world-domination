...
ROOT_URLCONF = 'worlddomination.urls'
...
WSGI_APPLICATION = 'worlddomination.wsgi.application'
...
SYSTEM_EMAIL_PREFIX = "[worlddomination]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_worlddomination"  # Make this unique to your project.
